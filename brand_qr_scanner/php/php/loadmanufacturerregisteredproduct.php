...
$sqlloadproduct = "SELECT * FROM `tbl_product` WHERE `product_name` LIKE '%$search%' AND `manufacturer_regid` = '$userid' ORDER BY manufacturer_regdate DESC";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $productlist['product_insertdate'] = $row['product_insertdate'];
