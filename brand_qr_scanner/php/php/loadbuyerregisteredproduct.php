...
$sqlloadproduct = "SELECT * FROM `tbl_product` WHERE `product_name` LIKE '%$search%' AND `buyer_id` = '$userid' ORDER BY buyer_regdate DESC";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $productlist['buyer_regdate'] = $row['buyer_regdate'];
